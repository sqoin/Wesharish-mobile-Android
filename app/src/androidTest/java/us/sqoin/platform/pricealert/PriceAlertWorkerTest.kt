package us.sqoin.platform.pricealert
...
import us.sqoin.model.PriceAlert
...
class PriceAlertWorkerTest {
    ...
    fun testTogglesHasBeenTriggeredWhenTriggered() {
        ...
        putRates(_root_ide_package_.us.com.breadwallet.presenter.entities.CurrencyEntity("USD", "Dollar", 101f, "BTC"))
    ...
    fun testDoesNotToggleHasBeenTriggeredWhenNotTriggered() {
        putAlerts(PriceAlert.priceTargetIncrease("BTC", 100f, "USD"))
        putRates(_root_ide_package_.us.com.breadwallet.presenter.entities.CurrencyEntity("USD", "Dollar", 100f, "BTC"))
    ...
    fun testTogglesHasBeenTriggeredWhenTriggerUnmet() {
        putAlerts(PriceAlert.priceTargetIncrease("BTC", 100f, "USD"))
        putRates(_root_ide_package_.us.com.breadwallet.presenter.entities.CurrencyEntity("USD", "Dollar", 99f, "BTC"))
    ...
    fun testUpdatesPinnedPriceWhenTriggered() {
        ...
        putRates(_root_ide_package_.us.com.breadwallet.presenter.entities.CurrencyEntity("USD", "Dollar", 90f, "BTC"))
    ...
    private fun putRates(vararg currencyEntity: _root_ide_package_.us.com.breadwallet.presenter.entities.CurrencyEntity) {
        val ratesRepo = _root_ide_package_.us.com.breadwallet.repository.RatesRepository.getInstance(InstrumentationRegistry.getTargetContext())
